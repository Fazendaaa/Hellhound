<!-- ⚠️ This README has been generated from the file(s) "blueprint.md" ⚠️--><h1 align="center">hellhound</h1>

<p align="center">
  <img src="https://raw.githubusercontent.com/Fazendaaa/Hellhound/master/assets/img/logo.svg" alt="Logo" width="150" height="150" />
</p>
...
<p align="center">
  <b>VSCode extension to integrate Jinn recipes </b></br>
  <sub><sub>
</p>
...
Welcome to Fazendaaa's hellhound. This is version 1.0.0!
...
Currently, in the company that I work for we have a CLI (Command Line Interface) made in [Python](https://www.python.org/) called `estat` that you can read more about it right [here](https://github.com/Fazendaaa/Succubus). As the CLI tool as many commands and features, one of them being able to set "recipes" for projects, the ideia behind hellhound is to have a marketplace to share thoses recipes to be used between many people and projects.
...
Licensed under [AGPL-3.0-or-later](https://opensource.org/licenses/AGPL-3.0-or-later).
